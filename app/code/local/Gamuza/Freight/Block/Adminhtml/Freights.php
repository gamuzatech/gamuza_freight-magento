...
class Gamuza_Freight_Block_Adminhtml_Freights
extends Mage_Adminhtml_Block_Widget_Grid_Container
{
	public function __construct()
	{
		...
		$this->_headerText = Mage::helper("freight")->__("Freights Manager");
		$this->_addButtonLabel = Mage::helper("freight")->__("Add New Item");
